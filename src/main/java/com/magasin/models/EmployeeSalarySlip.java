...
@Entity
@Table(name = "EmployeeSalarySlip")
@Getter
@Setter
public class EmployeeSalarySlip extends BaseEntity {
	...
	@Column(name = "SlipID", nullable = false)
	private Long slipId;
	...
	@Column(name = "SalaryUSD", precision = 18, scale = 2)
	private BigDecimal salaryUSD;

	@Column(name = "NetSalaryUSD", precision = 18, scale = 2)
